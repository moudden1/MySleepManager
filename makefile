...
all : build/getDataGoogleMaps2.o src/reveil.c build/getDataMeteo.o src/affiche_heur.c build/alarm_graph.o
	$(c) `pkg-config --cflags gtk+-3.0` -I./include -o bin/reveil build/getDataGoogleMaps2.o build/alarm_graph.o src/reveil.c -lpthread -lcurl -ljson-c -lwiringPi -lmosquitto `pkg-config --libs gtk+-3.0`
